...
- **Trang chủ (Landing Page):** Cổng điều hướng cho phép sinh viên chọn vào khu vực học lý thuyết (Knowledge Campus) hoặc vào thẳng Đấu trường thi đấu.
- **Phần lý thuyết (Knowledge Campus):** Cung cấp các trang chi tiết bài học/chương học, tích hợp Sơ đồ tư duy 3D (Concept Galaxy) và Timeline lịch sử.
...
### 6.1. Chức năng học lý thuyết (Knowledge Campus)
Hệ thống học tập phi tuyến tính, cho phép sinh viên tiếp cận bài giảng bằng nhiều hình thức trực quan:
- **Concept Galaxy:** Biểu diễn các khái niệm của Tư tưởng Hồ Chí Minh dưới dạng không gian 3D nối kết (Node graph), giúp sinh viên thấy được tính hệ thống của các luận điểm.
- **Timeline Lịch sử:** Trục thời gian trải dài các mốc sự kiện quan trọng trong quá trình hình thành tư tưởng của Người.
- **Danh sách Chương/Bài:** Nội dung môn học được cấu trúc theo chuẩn giáo trình. Sinh viên tự do điều hướng và hệ thống sẽ lưu lại tiến độ học tập.

`[Ảnh 1: Giao diện Knowledge Campus / Concept Galaxy]`
...
2. **Kích thích học tập chủ động:** Để thắng trong game, sinh viên buộc phải tìm hiểu trước bài ở nhà trên hệ thống Knowledge Campus.
...
**Luồng học tập (Tự do):**
1. Sinh viên vào trang chủ $\rightarrow$ Chọn `Knowledge Campus`.
2. Trải nghiệm đồ họa 3D Galaxy Concept hoặc cuộn qua Timeline sự kiện.
3. Nhấp vào từng Chương/Bài để đọc lý thuyết, hệ thống tự động lưu trữ tiến độ cá nhân.
...
- Phần lý thuyết (Knowledge Campus) hiện tại chủ yếu tập trung vào tương tác trực quan (timeline, biểu đồ), cần đa dạng thêm bằng các bài giảng dạng Video/Podcast.
