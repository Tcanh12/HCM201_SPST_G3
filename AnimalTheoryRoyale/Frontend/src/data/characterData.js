...
export const CHARACTER_DATA = {
  1: {
    ...
    skills: {
      passive: { name: 'Bền Bỉ', desc: 'Giảm sát thương nhận từ bo 20%', icon: '🛡️' },
      push: { name: 'Đẩy Lùi', desc: 'Đẩy văng đối thủ trước mặt ra xa', icon: '💨' },
      double: { name: 'Liều Ăn Nhiều', desc: 'Đúng x2 điểm, Sai x2 sát thương', icon: '🎲' },
      dizzy: { name: 'Chóng Mặt', desc: 'Gây choáng kẻ địch xung quanh 5s', icon: '🌀' },
      ultimate: { name: 'Dậm Đất', desc: 'Sóng chấn động hình trống đồng, gây sát thương và làm chậm', icon: '🥁', visualDesc: 'Sóng xung kích hình trống đồng / ánh sáng vàng' },
    },
  ...
  2: {
    ...
    skills: {
      passive: { name: 'Linh Hoạt', desc: 'Di chuyển nhanh hơn 15% khi máu dưới 50%', icon: '⚡' },
      push: { name: 'Đẩy Lùi', desc: 'Đẩy văng đối thủ trước mặt ra xa', icon: '💨' },
      double: { name: 'Liều Ăn Nhiều', desc: 'Đúng x2 điểm, Sai x2 sát thương', icon: '🎲' },
      dizzy: { name: 'Chóng Mặt', desc: 'Gây choáng kẻ địch xung quanh 5s', icon: '🌀' },
      ultimate: { name: 'Lướt Nhanh', desc: 'Lao cực nhanh theo hướng nhìn để né đòn', icon: '💨', visualDesc: 'Vệt sáng xanh/vàng khi chạy' },
    },
  ...
  3: {
    ...
    skills: {
      passive: { name: 'Nhạy Bén', desc: 'Thấy được bẫy trong phạm vi gần', icon: '👁️' },
      push: { name: 'Đẩy Lùi', desc: 'Đẩy văng đối thủ trước mặt ra xa', icon: '💨' },
      double: { name: 'Liều Ăn Nhiều', desc: 'Đúng x2 điểm, Sai x2 sát thương', icon: '🎲' },
      dizzy: { name: 'Chóng Mặt', desc: 'Gây choáng kẻ địch xung quanh 5s', icon: '🌀' },
      ultimate: { name: 'Bẫy Ảo Ảnh', desc: 'Đặt bẫy tàng hình, địch dẫm phải sẽ mất máu và bị chậm', icon: '🪤', visualDesc: 'Hologram, ảo ảnh, nhiễu điều khiển' },
    },
  ...
  4: {
    ...
    skills: {
      passive: { name: 'Bất Khuất', desc: 'Giảm 30% thời gian bị choáng', icon: '🧱' },
      push: { name: 'Đẩy Lùi', desc: 'Đẩy văng đối thủ trước mặt ra xa', icon: '💨' },
      double: { name: 'Liều Ăn Nhiều', desc: 'Đúng x2 điểm, Sai x2 sát thương', icon: '🎲' },
      dizzy: { name: 'Chóng Mặt', desc: 'Gây choáng kẻ địch xung quanh 5s', icon: '🌀' },
      ultimate: { name: 'Mai Rùa', desc: 'Tạo khiên năng lượng hình vòng tròn bảo vệ', icon: '🛡️', visualDesc: 'Khiên năng lượng hình vòng tròn phát sáng' },
    },
